...
<sql:setDataSource var="ds"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <!-- get info on product count -->
                <h3>Pizza Analysis</h3>
                <sql:query dataSource="${ds}" var="rs">
               select sum(o.quantity) as quantity, p.productname from orders o left join product p on o.productID = p.productID group by p.productname
                </sql:query>
                <table border = "1px">
				<c:forEach var = "row" items="${rs.rows}">
				<tr><th>Quantity<th>Product Name</th></tr>
				<tr><td>${row.quantity}</td><td>${row.productname}</tr>	
				</c:forEach>
				</table>
