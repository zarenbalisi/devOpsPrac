    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <h3>Pizza Mobiles</h3>
                <sql:query dataSource="${ds}" var="rs">SELECT * from Vehicle</sql:query>
                <table border = "1px">
				<c:forEach var = "row" items="${rs.rows}">
				<tr><th>Vin Num<th>Make</th><th>Model</th><th>Year</th></tr>
				<tr><td>${row.Vinnumber}</td><td>${row.Make}</td><td>${row.Model}</td><td>${row.Year}</td></tr>	
				</c:forEach>
				</table>
                </div>
            </div>
