...
<div class="brand">Zee Pizza</div>
    ...
    <div class="container">
    	<div class="row">
            <div class="box">
            <h3>Menu</h3>
            <!-- puts contents from the query into a drop down, that leads to the pizza jsp -->
                <sql:query dataSource="${ds}" var="rs">SELECT distinct ProductName from Product</sql:query>
				<select name="Pizza" id="Pizza" size="4">
				<tr><th>Choose a Pizza</th><tr>
